...
public class SortDriverByPoints {

    public SortDriverByPoints() {
        ArrayList<Driver> myDriverList = new ArrayList<>();
    ...
    public void bubbleSort(ArrayList<Driver> myList) {
        ...
        do {
            ...
            for (int intCounter = 0; intCounter < (myList.size() - 1); intCounter++) {
                ...
                if (driver2.isBiggerThan(driver1)) {
                    swap = true;
    ...
    public static void main(String[] args) {
        SortDriverByPoints newInstance = new SortDriverByPoints();
    }
